...
fn test_get_vertice_position_with_width() {
    let vertice_position = Position { x: 200.0, y: -300.0 };
    let actual = vertice_position.get_vertice_position(Some(&Size { width: 100.0, height: 0.0 }));
...
fn test_get_vertice_position_with_height() {
    let vertice_position = Position { x: 200.0, y: -300.0 };
    let actual = vertice_position.get_vertice_position(Some(&Size { width: 0.0, height: 100.0 }));
...
fn test_get_vertice_position_with_full_size() {
    let vertice_position = Position { x: 200.0, y: -300.0 };
    let actual = vertice_position.get_vertice_position(Some(&Size { width: 200.0, height: 100.0 }));

    ...
    pub fn next_level(&mut self, player: &mut Player) {
        ...
        match self.current_level {
            1 => {
                ...
                self.insert_object(ObjectLevel::new(ObjectLevelType::ExitDoor, Position { x: 1697.0, y: 620.0 }, Size { width: 70.0, height: 60.0 }, false, None, None));
            ...
            2 => {
                ...
                self.insert_object(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 375.0, y: 510.0 }, Size { width: DEFAULT_SIZE + 20.0, height: 70.0 }, false, None, None));
                ...
                self.insert_object(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 150.0, y: 232.0 }, Size { width: DEFAULT_SIZE + 20.0, height: 70.0 }, false, None, None));
                ...
                self.insert_object(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 545.0, y: 420.0 }, Size { width: DEFAULT_SIZE + 20.0, height: 70.0 }, false, None, None));
                ...
                self.insert_object(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 1370.0, y: 510.0 }, Size { width: DEFAULT_SIZE + 20.0, height: 70.0 }, false, None, None));
                ...
                self.insert_object(ObjectLevel::new(ObjectLevelType::ExitDoor, Position { x: 1700.0, y: 0.0 }, Size { width: 70.0, height: 60.0 }, false, None, None));
            ...
            3 => {
                player.move_to(Position { x: 750.0, y: 5.0 }, false);

                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 590.0, y: 10.0 }, "10d 12r 32d 32u 12l 10u", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 260.0, y: 10.0 }, "10d 14l 28r 14l 10u", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 310.0, y: 220.0 }, "1r 15l 14r", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 440.0, y: 325.0 }, "6d 3r 12d 12u 3l 6u", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 180.0, y: 540.0 }, "25r 25l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 80.0, y: 330.0 }, "7l 30r 23l", false));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 680.0, y: 65.0 }, Size { width: 120.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 676.5, y: 0.0 }, Size { width: 40.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 540.0, y: 0.0 }, Size { width: 40.0, height: 170.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 495.0, y: 0.0 }, Size { width: 45.0, height: 80.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 520.0, y: 90.0 }, Size { width: 30.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 540.0, y: 170.0 }, Size { width: 160.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 595.0, y: 95.0 }, Size { width: 45.0, height: 80.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 660.0, y: 210.0 }, Size { width: 40.0, height: 170.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 755.0, y: 190.0 }, Size { width: 45.0, height: 80.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 680.0, y: 290.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 540.0, y: 380.0 }, Size { width: 160.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 540.0, y: 420.0 }, Size { width: 40.0, height: 110.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 495.0, y: 450.0 }, Size { width: 45.0, height: 80.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 660.0, y: 420.0 }, Size { width: 40.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 580.0, y: 430.0 }, Size { width: 50.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 580.0, y: 490.0 }, Size { width: 220.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 670.0, y: 505.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 180

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::LockedDoor, Position { x: 535.0, y: 530.0 }, Size { width: 50.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 610.0, y: 540.0 }, Size { width: 50.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 750.0, y: 550.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Key, Position { x: 615.0, y: 210.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 610.0, y: 270.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 610.0, y: 318.0 }, Size { width: 50.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 540.0, y: 210.0 }, Size { width: 40.0, height: 170.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 560.0, y: 260.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 45
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 495.0, y: 270.0 }, Size { width: 45.0, height: 80.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 0.0, y: 65.0 }, Size { width: 140.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 104.0, y: 0.0 }, Size { width: 40.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 5.0, y: 3.5 }, Size { width: 50.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 0.0, y: 170.0 }, Size { width: 240.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 200.0, y: 95.0 }, Size { width: 45.0, height: 80.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 10.0, y: 130.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 240.0, y: 170.0 }, Size { width: 250.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 490.0, y: 170.0 }, Size { width: 50.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 383.0, y: 210.0 }, Size { width: 40.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 250.0, y: 210.0 }, Size { width: 45.0, height: 75.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 125.0, y: 210.0 }, Size { width: 40.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 60.0, y: 220.0 }, Size { width: 50.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::LockedDoor, Position { x: 0.0, y: 278.0 }, Size { width: 55.0, height: 50.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 50.0, y: 280.0 }, Size { width: 370.0, height: 45.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 190.0, y: 300.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 180

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 380.0, y: 325.0 }, Size { width: 40.0, height: 205.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 420.0, y: 450.0 }, Size { width: 45.0, height: 80.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 170.0, y: 490.0 }, Size { width: 210.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 240.0, y: 505.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 180
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 310.0, y: 532.0 }, Size { width: 45.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 180.0, y: 532.0 }, Size { width: 45.0, height: 70.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 0.0, y: 490.0 }, Size { width: 120.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::LockedDoor, Position { x: 112.0, y: 490.0 }, Size { width: 65.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 78.0, y: 530.0 }, Size { width: 40.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::ExitDoor, Position { x: 0.0, y: 530.0 }, Size { width: 60.0, height: 70.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 100.0, y: 325.0 }, Size { width: 45.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 250.0, y: 325.0 }, Size { width: 45.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 0.0, y: 390.0 }, Size { width: 330.0, height: 35.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 330.0, y: 395.0 }, Size { width: 50.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 200.0, y: 400.0 }, Size { width: 30.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 70.0, y: 425.0 }, Size { width: 40.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 5.0, y: 450.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
            },

            4 => {
                player.move_to(Position { x: 0.0, y: 540.0 }, false);

                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 140.0, y: 540.0 }, "22r 22l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 532.0, y: 437.0 }, "8r 10d 10l 10r 10u 12r 20l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 560.0, y: 332.0 }, "18r 18l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 510.0, y: 170.0 }, "5d 20r 5u 20l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 540.0, y: 5.0 }, "6d 15r 6u 15l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 0.0, y: 190.0 }, "15d 15u", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 110.0, y: 190.0 }, "15d 15u", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 230.0, y: 190.0 }, "16d 12l 12r 16u", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 110.0, y: 0.0 }, "11r 11l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 420.0, y: 370.0 }, "6d 6u", false));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 0.0, y: 500.0 }, Size { width: 120.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 83.0, y: 540.0 }, Size { width: 40.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 120.0, y: 500.0 }, Size { width: 120.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 170.0, y: 540.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 237.0, y: 500.0 }, Size { width: 60.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 297.0, y: 500.0 }, Size { width: 180.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 330.0, y: 540.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 438.0, y: 540.0 }, Size { width: 40.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 477.0, y: 500.0 }, Size { width: 130.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 545.0, y: 515.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 180
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 607.0, y: 500.0 }, Size { width: 60.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 495.0, y: 540.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 667.0, y: 540.0 }, Size { width: 30.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 667.0, y: 500.0 }, Size { width: 80.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 747.0, y: 500.0 }, Size { width: 53.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Key, Position { x: 700.0, y: 560.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 300.0, y: 125.0 }, Size { width: 80.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::LockedDoor, Position { x: 372.0, y: 125.0 }, Size { width: 65.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 430.0, y: 125.0 }, Size { width: 80.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 470.0, y: 165.0 }, Size { width: 40.0, height: 50.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::LockedDoor, Position { x: 462.0, y: 214.0 }, Size { width: 55.0, height: 67.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 470.0, y: 281.0 }, Size { width: 40.0, height: 50.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 300.0, y: 165.0 }, Size { width: 40.0, height: 50.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 297.0, y: 215.5 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 300.0, y: 281.0 }, Size { width: 40.0, height: 50.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 300.0, y: 328.0 }, Size { width: 80.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::CodedDoor, Position { x: 367.0, y: 325.0 }, Size { width: 75.0, height: 43.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 430.0, y: 328.0 }, Size { width: 80.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::ExitDoor, Position { x: 370.0, y: 210.0 }, Size { width: 70.0, height: 80.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 480.0, y: 368.0 }, Size { width: 30.0, height: 133.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 330.0, y: 420.0 }, Size { width: 80.0, height: 20.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 382.0, y: 440.0 }, Size { width: 30.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 330.0, y: 443.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 437.0, y: 440.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 437.0, y: 366.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 330.0, y: 380.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 300.0, y: 368.0 }, Size { width: 30.0, height: 133.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 507.0, y: 395.0 }, Size { width: 55.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 562.0, y: 395.0 }, Size { width: 238.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 720.0, y: 410.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 180
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 562.0, y: 437.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 682.0, y: 437.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 510.0, y: 281.0 }, Size { width: 120.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 630.0, y: 281.0 }, Size { width: 55.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 685.0, y: 281.0 }, Size { width: 115.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 580.0, y: 332.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 700.0, y: 332.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 760.0, y: 355.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 510.0, y: 125.0 }, Size { width: 235.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 745.0, y: 125.0 }, Size { width: 55.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 680.0, y: 140.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 180
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 580.0, y: 216.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 510.0, y: 165.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 755.0, y: 216.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 470.0, y: 0.0 }, Size { width: 40.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 466.0, y: 61.0 }, Size { width: 48.0, height: 64.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Key, Position { x: 520.0, y: 5.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 680.0, y: 62.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 550.0, y: 62.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 300.0, y: 0.0 }, Size { width: 40.0, height: 125.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 380.0, y: 10.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 320.0, y: 60.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270 and then 45

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 50.0, y: 410.0 }, Size { width: 250.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 0.0, y: 410.0 }, Size { width: 50.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 170.0, y: 442.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 100.0, y: 415.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 70.0, y: 150.0 }, Size { width: 30.0, height: 260.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 50.0, y: 150.0 }, Size { width: 17.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 0.0, y: 150.0 }, Size { width: 50.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 50.0, y: 260.0 }, Size { width: 30.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 30.0, y: 330.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 30.0, y: 190.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 0.0, y: 60.0 }, Size { width: 250.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 250.0, y: 60.0 }, Size { width: 50.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 175.0, y: 65.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 260.0, y: 110.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::CodePaper, Position { x: 210.0, y: 110.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 150.0, y: 150.0 }, Size { width: 150.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 100.0, y: 150.0 }, Size { width: 50.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 180.0, y: 180.0 }, Size { width: 40.0, height: 170.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 180.0, y: 350.0 }, Size { width: 40.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 160.0, y: 220.0 }, Size { width: 30.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 100.0, y: 190.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 135.0, y: 260.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 100.0, y: 350.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 200.0, y: 275.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 45
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 255.0, y: 350.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 220.0, y: 180.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 260.0, y: 190.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 50.0, y: 0.0 }, Size { width: 40.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 0.0, y: 3.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 200.0, y: 5.0 }, Size { width: 45.0, height: 57.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 110.0, y: 5.0 }, Size { width: 45.0, height: 57.0 }, false, None, None));
            },

            5 => {
                player.move_to(Position { x: 370.0, y: 275.0 }, false);

                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 530.0, y: 540.0 }, "18r 34l 12u 12d 16r", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 600.0, y: 430.0 }, "12r 12l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 110.0, y: 540.0 }, "16r 16l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 120.0, y: 130.0 }, "17r 17l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 60.0, y: 352.0 }, "17r 17l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 505.0, y: 230.0 }, "12d 12u", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 615.0, y: 130.0 }, "11d 11u", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 740.0, y: 245.0 }, "12l 10d 10u 12r", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 540.0, y: 20.0 }, "14r 14l", false));
                self.enemies.push(Enemy::new(EnemyType::Regular, Position { x: 310.0, y: 20.0 }, "12r 12l", false));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 305.0, y: 190.0 }, Size { width: 190.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 455.0, y: 230.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 452.0, y: 270.5 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 455.0, y: 336.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 302.0, y: 230.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 305.0, y: 295.0 }, Size { width: 40.0, height: 80.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 305.0, y: 373.0 }, Size { width: 65.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 367.0, y: 373.0 }, Size { width: 60.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 425.0, y: 373.0 }, Size { width: 70.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 330.0, y: 413.0 }, Size { width: 40.0, height: 187.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 435.0, y: 413.0 }, Size { width: 40.0, height: 120.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 432.0, y: 534.0 }, Size { width: 45.0, height: 67.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 415.0, y: 460.0 }, Size { width: 30.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 370.0, y: 420.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 370.0, y: 535.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 475.0, y: 493.0 }, Size { width: 275.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 750.0, y: 493.0 }, Size { width: 50.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 620.0, y: 508.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 520.0, y: 535.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 690.0, y: 535.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 760.0, y: 550.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 475.0, y: 413.0 }, Size { width: 325.0, height: 10.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 540.0, y: 424.0 }, Size { width: 40.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 610.0, y: 408.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 680.0, y: 430.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 480.0, y: 436.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 0.0, y: 413.0 }, Size { width: 330.0, height: 10.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 240.0, y: 423.0 }, Size { width: 30.0, height: 112.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 238.0, y: 536.0 }, Size { width: 35.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 280.0, y: 423.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 250.0, y: 480.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 285.0, y: 535.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 0.0, y: 495.0 }, Size { width: 180.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 180.0, y: 495.0 }, Size { width: 55.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 50.0, y: 536.0 }, Size { width: 40.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 120.0, y: 535.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::CodePaper, Position { x: 5.0, y: 550.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 42.0, y: 423.0 }, Size { width: 40.0, height: 72.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 0.0, y: 438.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 110.0, y: 408.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270 (repeat)
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 195.0, y: 422.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::CodedDoor, Position { x: 0.0, y: 185.0 }, Size { width: 55.0, height: 35.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 50.0, y: 190.0 }, Size { width: 255.0, height: 30.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 0.0, y: 80.0 }, Size { width: 50.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 50.0, y: 80.0 }, Size { width: 250.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 300.0, y: 80.0 }, Size { width: 250.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 550.0, y: 80.0 }, Size { width: 200.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 750.0, y: 80.0 }, Size { width: 50.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 680.0, y: 15.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 610.0, y: 0.0 }, Size { width: 30.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 530.0, y: 15.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 480.0, y: 0.0 }, Size { width: 40.0, height: 80.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 425.0, y: 15.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 365.0, y: 30.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 300.0, y: 15.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 250.0, y: 0.0 }, Size { width: 40.0, height: 80.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 195.0, y: 15.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 140.0, y: 0.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270 (repeat)

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 455.0, y: 120.0 }, Size { width: 40.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::TeleportDoor, Position { x: 410.0, y: 133.0 }, Size { width: 45.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 360.0, y: 120.0 }, Size { width: 40.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::CodedDoor, Position { x: 55.0, y: 120.0 }, Size { width: 55.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 220.0, y: 95.0 }, Size { width: 30.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 280.0, y: 125.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 130.0, y: 125.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 210.0, y: 145.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 10.0, y: 135.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::LockedDoor, Position { x: 70.0, y: 0.0 }, Size { width: 45.0, height: 80.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::ExitDoor, Position { x: 5.0, y: 10.0 }, Size { width: 70.0, height: 60.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 210.0, y: 220.0 }, Size { width: 30.0, height: 125.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 207.0, y: 345.0 }, Size { width: 35.0, height: 70.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 220.0, y: 280.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270 and 45
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 260.0, y: 350.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 0.0, y: 315.0 }, Size { width: 50.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 50.0, y: 315.0 }, Size { width: 160.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 100.0, y: 320.0 }, Size { width: 30.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 145.0, y: 350.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 70.0, y: 360.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 5.0, y: 350.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 60.0, y: 220.0 }, Size { width: 30.0, height: 34.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 57.0, y: 255.0 }, Size { width: 35.0, height: 60.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::CodePaper, Position { x: 165.0, y: 225.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 170.0, y: 275.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Camera, Position { x: 110.0, y: 195.0 }, Size { width: 30.0, height: 30.0 }, false, None, None)); // rotate here 270

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 495.0, y: 190.0 }, Size { width: 100.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 552.0, y: 120.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Key, Position { x: 500.0, y: 140.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 562.0, y: 220.0 }, Size { width: 35.0, height: 72.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 565.0, y: 290.0 }, Size { width: 30.0, height: 50.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::LockedDoor, Position { x: 560.0, y: 340.0 }, Size { width: 40.0, height: 75.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 495.0, y: 220.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 495.0, y: 350.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 595.0, y: 280.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 680.0, y: 315.0 }, Size { width: 30.0, height: 100.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 710.0, y: 315.0 }, Size { width: 40.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 750.0, y: 315.0 }, Size { width: 50.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Coin, Position { x: 760.0, y: 365.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Key, Position { x: 715.0, y: 365.0 }, Size { width: 40.0, height: 40.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 635.0, y: 350.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 700.0, y: 250.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));

                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 680.0, y: 120.0 }, Size { width: 30.0, height: 100.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::Wall, Position { x: 710.0, y: 190.0 }, Size { width: 40.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::RegularDoor, Position { x: 750.0, y: 190.0 }, Size { width: 50.0, height: 30.0 }, false, None, None));
                self.level_objects.push(ObjectLevel::new(ObjectLevelType::HidePlace, Position { x: 635.0, y: 120.0 }, Size { width: 45.0, height: 65.0 }, false, None, None));
